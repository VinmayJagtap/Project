...
public class Medium_TC_02POM {
private WebDriver driver; 

	
	public Medium_TC_02POM(WebDriver driver) {
		this.driver = driver; 
	...
	private WebElement BlogsOV;
	
	public void ValidateBlogs() {
		this.BlogsOV.isDisplayed();
		String act=this.BlogsOV.getText();
		assertEquals(act, "Blog");
	}
		
	@FindBy(xpath="//input[@placeholder='Search here for Properties..']")
	private WebElement SearchBox;
	
	public void SearchBoxEnter(String Blogs) {
		this.SearchBox.sendKeys(Blogs);
	}
